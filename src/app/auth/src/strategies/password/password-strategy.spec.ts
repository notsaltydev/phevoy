...
describe('password-auth-strategy', () => {
    ...
    const successToken = authCreateToken(AuthSimpleToken, 'token', ownerStrategyName);
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            providers: [
                {provide: PasswordAuthStrategy, useClass: PasswordAuthStrategy},
            ],
        });
    });

    beforeEach(async(inject(
        [PasswordAuthStrategy, HttpTestingController],
        (_strategy, _httpMock) => {
            strategy = _strategy;
            httpMock = _httpMock;
