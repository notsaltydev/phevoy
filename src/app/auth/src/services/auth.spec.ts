...
describe('auth-service', () => {
    ...
    const testToken = authCreateToken(AuthSimpleToken, testTokenValue, ownerStrategyName);
    const invalidToken = authCreateToken(AuthSimpleToken, testTokenValue, ownerStrategyName);
    const emptyToken = authCreateToken(AuthSimpleToken, null, null);

    const failResult = new AuthResult(false,
        resp401,
        null,
        ['Something went wrong.']);

    const successResult = new AuthResult(true,
        resp200,
        '/',
        [],
    ...
    const successLogoutResult = new AuthResult(true,
        resp200,
        '/',
        [],
        ['Successfully logged out.']);

    const successResetPasswordResult = new AuthResult(true,
        resp200,
        '/',
        [],
        ['Successfully reset password.']);

    const successRequestPasswordResult = new AuthResult(true,
        resp200,
        '/',
        [],
        ['Successfully requested password.']);

    const successRefreshTokenResult = new AuthResult(true,
        resp200,
        null,
        [],
    ...
    it('get test token before set', () => {
            ...
            authService.getToken().subscribe((val: AuthSimpleToken) => {
    ...
    it('onTokenChange return correct stream and gets test token', (done) => {
            ...
            authService.onTokenChange()
                .pipe(first())
                .subscribe((token: AuthSimpleToken) => {
                    expect(spy).toHaveBeenCalled();
    ...
    it('authenticate failed', (done) => {
            ...
            authService.authenticate(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
    ...
    it('register failed', (done) => {
            ...
            authService.register(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
                expect(authRes.isFailure()).toBeTruthy();
                expect(authRes.isSuccess()).toBeFalsy();
                expect(authRes.getMessages()).toEqual([]);
    ...
    it('logout failed', (done) => {
            ...
            authService.logout(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
    ...
    it('requestPassword failed', (done) => {
            ...
            authService.requestPassword(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
    ...
    it('resetPassword failed', (done) => {
            ...
            authService.resetPassword(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
    ...
    it('refreshToken failed', (done) => {
            ...
            authService.refreshToken(ownerStrategyName).subscribe((authRes: AuthResult) => {
                expect(spy).toHaveBeenCalled();
                expect(authRes.isFailure()).toBeTruthy();
                expect(authRes.isSuccess()).toBeFalsy();
                expect(authRes.getMessages()).toEqual([]);
